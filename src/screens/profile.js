...
<a id="menu-priority" class="cursor-pointer flex items-center gap-4 p-4 hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors border-b border-slate-200 dark:border-slate-800">
<div class="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
...
<a id="menu-personalization" class="cursor-pointer flex items-center gap-4 p-4 hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors">
<div class="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
<span class="material-symbols-outlined">palette</span>
</div>
<div class="flex-1">
<p class="font-semibold">Cá nhân hóa Neo</p>
<p class="text-xs text-slate-500 dark:text-slate-400">Tùy chỉnh giao diện, màu sắc, phông chữ</p>
</div>
<span class="material-symbols-outlined text-slate-400">chevron_right</span>
</a>
</div>
...
<p class="text-xs text-slate-500 dark:text-slate-600">NeoBank v1.0.0 (Build 2024)</p>
  ...
  function attachEvents() {
    ...
    container.querySelector('#menu-personalization').addEventListener('click', () => navigate('personalization'));
